...
**EDIC Design System** (formerly CGArtLab) — Editorial × Olive Green, a zero-runtime-dependency static design system driven by OKLch color science and design tokens. Current version: **v{{DS_VERSION}}**.
...
# 4. Commit
git add -A && git commit -m "chore(release): bump to v{{DS_VERSION}}"

# 5. Tag & push
git tag v{{DS_VERSION}} && git push origin v{{DS_VERSION}}
```
